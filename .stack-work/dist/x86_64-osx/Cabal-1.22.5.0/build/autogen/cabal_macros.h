...
/* package http-dispatch-0.5.0.0 */
#define VERSION_http_dispatch "0.5.0.0"
#define MIN_VERSION_http_dispatch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
...
#define CURRENT_PACKAGE_KEY "bugsn_CMldjK77m5c9DwfVRIw7lb"
